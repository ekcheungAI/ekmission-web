...
const navItems = [
  ...
  { href: "/git", label: "Git", icon: GitIcon },
  { href: "/actions", label: "Actions", icon: TerminalIcon },
    ...
    <aside className="w-64 h-screen border-r border-white/10 bg-black/50 fixed left-0 top-0 flex flex-col">
      ...
      <div className="p-6 border-b border-white/10">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xl font-semibold tracking-tight text-white">ekmission</span>
      ...
      <div className="p-4 border-t border-white/10">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-white/60 hover:text-white text-sm transition-all border border-transparent hover:border-white/10"
        >
